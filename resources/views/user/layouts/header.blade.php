                    ...
                    <nav class="navbar top-navbar col-lg-12 col-12 p-0">
                        <div class="container-fluid">
                            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                                <a class="navbar-brand brand-logo" href="index-2.html"><img src="img/core-img/logo.png" alt="logo" /></a>
                                <a class="navbar-brand brand-logo-mini" href="index-2.html"><img src="img/core-img/small-logo.png" alt="logo" /></a>
                            </div>
                                ...
                                <ul class="top-navbar-area navbar-nav navbar-nav-right">
                                    ...
                                    <li class="nav-item nav-profile dropdown dropdown-animate">
                                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                                            <img src="{{asset('asset/img/member-img/contact-3.jpg')}}" alt="profile" />
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown profile-top" aria-labelledby="profileDropdown">
                                            <div class="profile-header d-flex align-items-center">
                                                <div class="thumb-area">
                                                    <img src="{{asset('asset/img/member-img/contact-3.jpg')}}" alt="Admin Image">
                                                </div>
                                    ...
                                    <div class="submenu">
                                        <div class="col-group-wrapper row">
                                            <div class="col-group col-md-4">
                                                <p class="category-heading">Forms</p>
                                                <ul class="submenu-item">
                                                    ...
                                                    <li class="nav-item"><a class="nav-link" href="form-switchers.html">Switcher</a></li>
                                            ...
                                            <div class="col-group col-md-4">
                                                <p class="category-heading">User Page</p>
                                                <ul class="submenu-item">
