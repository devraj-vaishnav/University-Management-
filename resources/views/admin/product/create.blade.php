                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                       class="form-control  border-warning" name="name"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="validationCustom02">Code <span
                                                        class="text-danger">*</span></label>
                                                <input type="text"
                                                       class="form-control border-warning" name="code"
                                                       id="validationCustom02"
                                                       required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="validationCustom02">HSN Code <span
                                                        class="text-danger">*</span></label>
                                                <input type="text"
                                                       class="form-control border-warning" name="hsn_code"
                                                       id="validationCustom02"
                                                       required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="validationCustom02">Buying Price<span
                                                        class="text-danger">*</span></label>
                                                <input type="number"
                                                       class="form-control border-warning" name="buying_price"
                                                       id="validationCustom02">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="validationCustom02">Selling Price<span
                                                        class="text-danger">*</span></label>
                                                <input type="number"
                                                       class="form-control border-warning" name="selling_price"
                                                       id="validationCustom02">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="validationCustom02">Quantity<span
                                                        class="text-danger">*</span></label>
                                                <input type="number"
                                                       class="form-control border-warning" name="quantity"
                                                       id="validationCustom02">
