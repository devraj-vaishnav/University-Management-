            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="needs-validation" method="post" action="{{route('party.update',$party->id)}}">
                                   @method('PUT')
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                       class="form-control border-warning" value="{{$party->party_name}}" name="party_name"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="validationCustom02">Contact Person Name <span
                                                        class="text-danger">*</span></label>
                                                <input type="text"
                                                       class="form-control border-warning" value="{{$party->contact_person_name}}" name="contact_person_name"
                                                       id="validationCustom02"
                                                       required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" minlength="10"  maxlength="10"
                                                       class="form-control number border-warning" value="{{$party->contact_number}}" name="contact_number"
                                                       id="validationCustom02"
                                                       required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control border-warning" value="{{$party->email_id}}" name="email_id"
                                                       id="validationCustom02"
                                                       required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="validationCustom02">GST Number<span
                                                        class="text-danger">*</span></label>
                                                <input type="text"
                                                       class="form-control border-warning" value="{{$party->gst_number}}" name="gst_number"
                                                       id="validationCustom02"
                                                       >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text"
                                                       class="form-control border-warning"  name="address"
                                                          id="validationCustom02">{{$party->address}}</textarea>
